  ...
  const calculateTotalAmounts = useCallback(
    (recommendations: any[], supplement: any) => {
      ...
      return {
        ...
        calculatedAmount,
        ashwagandha:
          supplement.baseAmounts.ashwagandha * Math.min(totalDoseCount, 1.5),
        rhodiolaRosea:
          supplement.baseAmounts.rhodiolaRosea * Math.min(totalDoseCount, 1.5),
        reasons,
      };
    },
...
export default useS09ProductOverview;
